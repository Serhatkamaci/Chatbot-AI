...
class GeminiClient:
    ...
    def generate(self, prompt: str, context: str = "") -> str:
        ...
        Eğer bağlam bilgileri yeterli değilse, bunu belirtin.
...
class DocumentQASystem:
    ...
    def interactive_mode(self):
        print("\n" + "=" * 50)
        print("🤖 Belge Soru-Cevap Sistemi")
        print("=" * 50)
        print("📋 Komutlar:")
...
def main():
    ...
    try:
        ...
        qa_system = DocumentQASystem(api_key=api_key, embedding_model=args.model)
